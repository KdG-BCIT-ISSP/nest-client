...
export default function Bookmark({
  ...
  const bookmarkColor = filled ? "#3b3c93" : "#CD6A6A";
  ...
  return (
    <div
      ...
      style={{
        ...
        cursor: post ? "pointer" : "",
        width: container || post ? "60px" : "40px",
      }}
    >
      <svg
        width="21"
      ...
      >
        <path
          ...
          fill={bookmarkColor} // Use dynamic color here
        />
      </svg>

      <span style={{ color: bookmarkColor, fontSize: "16px" }}>{count}</span>
    </div>
  );
}
